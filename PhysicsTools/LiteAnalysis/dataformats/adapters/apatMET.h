...
//              
// Created:     Thu Jan 14 23:48:22 2010 by mkadapter.py  HBP
//-----------------------------------------------------------------------------
...
class apatMET : public pat::MET
{
 public: 
  ...
  size_t genMET_numberOfDaughters() const 	{return genMET() ? genMET()->numberOfDaughters() : 999999;}
  size_t genMET_numberOfMothers() const 	{return genMET() ? genMET()->numberOfMothers() : 999999;}
