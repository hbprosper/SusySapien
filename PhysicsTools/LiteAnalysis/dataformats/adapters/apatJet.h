...
//              
// Created:     Fri Jan 15 21:58:21 2010 by mkadapter.py  HBP
//-----------------------------------------------------------------------------
...
class apatJet : public pat::Jet
{
 public: 
  ...
  bool daughter_massConstraint(size_t x) const 	{return daughter(x) ? daughter(x)->massConstraint() : false;}
  ...
  bool genJet_massConstraint() const 	{return genJet() ? genJet()->massConstraint() : false;}
  ...
  int genParton_collisionId() const 	{return genParton() ? genParton()->collisionId() : -999999;}
  ...
  bool genParton_massConstraint() const 	{return genParton() ? genParton()->massConstraint() : false;}
