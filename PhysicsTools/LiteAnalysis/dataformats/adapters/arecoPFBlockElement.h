#ifndef ARECOPFBLOCKELEMENT_H
#define ARECOPFBLOCKELEMENT_H
//-----------------------------------------------------------------------------
// Package:     PhysicsTools
// Sub-Package: LiteAnalysis
// Class:       arecoPFBlockElement
// Description: Simple adapter for:
//              class:   reco::PFBlockElement
//              header:  DataFormats/ParticleFlowReco/interface/PFBlockElement.h
//              
// Created:     Fri Jan 15 21:58:15 2010 by mkadapter.py  HBP
//-----------------------------------------------------------------------------
#include "DataFormats/ParticleFlowReco/interface/PFBlockElement.h"
//-----------------------------------------------------------------------------
class arecoPFBlockElement : public reco::PFBlockElement
{
 public: 
  arecoPFBlockElement() {}
  arecoPFBlockElement(const reco::PFBlockElement& o)
    : reco::PFBlockElement(o) {}
  ~arecoPFBlockElement() {}
