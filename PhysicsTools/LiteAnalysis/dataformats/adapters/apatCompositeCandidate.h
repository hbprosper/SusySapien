#ifndef APATCOMPOSITECANDIDATE_H
#define APATCOMPOSITECANDIDATE_H
//-----------------------------------------------------------------------------
// Package:     PhysicsTools
// Sub-Package: LiteAnalysis
// Class:       apatCompositeCandidate
// Description: Simple adapter for:
//              class:   pat::CompositeCandidate
//              header:  DataFormats/PatCandidates/interface/CompositeCandidate.h
//              
// Created:     Thu Jan 14 23:48:15 2010 by mkadapter.py  HBP
//-----------------------------------------------------------------------------
#include "DataFormats/PatCandidates/interface/CompositeCandidate.h"
//-----------------------------------------------------------------------------
class apatCompositeCandidate : public pat::CompositeCandidate
{
 public: 
  apatCompositeCandidate() {}
  apatCompositeCandidate(const pat::CompositeCandidate& o)
    : pat::CompositeCandidate(o) {}
  ~apatCompositeCandidate() {}
