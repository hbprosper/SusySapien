#ifndef APATPARTICLE_H
#define APATPARTICLE_H
//-----------------------------------------------------------------------------
...
//              class:   pat::Particle
//              header:  DataFormats/PatCandidates/interface/Particle.h
//              
// Created:     Thu Jan 14 23:48:24 2010 by mkadapter.py  HBP
//-----------------------------------------------------------------------------
#include "DataFormats/PatCandidates/interface/Particle.h"
//-----------------------------------------------------------------------------
class apatParticle : public pat::Particle
{
 public: 
  apatParticle() {}
  apatParticle(const pat::Particle& o)
    : pat::Particle(o) {}
  ~apatParticle() {}
