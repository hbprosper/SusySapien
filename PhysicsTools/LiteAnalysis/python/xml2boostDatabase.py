...
def isNoncopyable(classname):
	...
	if find(ctype, 'privatecopyctor') > -1: return 1
	if find(ctype, 'protectedcopyctor') > -1: return 1
...
def isNonconstructable(classname):
	...
	if element == None: return 0
	ctype = element.attrib['type']
	if find(ctype, 'privatedefctor') > -1: return 1
	if find(ctype, 'protectedefctor') > -1: return 1

def isNondestroyable(classname):
	...
	if element == None: return 0
	ctype = element.attrib['type']
	if find(ctype, 'privatedtor') > -1: return 1
	if find(ctype, 'protecteddtor') > -1: return 1	
#---------------------------------------------------------------------------
